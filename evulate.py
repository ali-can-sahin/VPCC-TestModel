...
def find_geometry():
	...
	begin = contents.find("SUMMARY --------------------------------------------------------",contents.find("SUMMARY --------------------------------------------------------")+len("SUMMARY --------------------------------------------------------"))
	temp=(contents[begin:len(contents)].split("\n")[2]).split(" ")
	return(temp[len(temp)-1])
def find_texture():

	
	begin = contents.find("SUMMARY --------------------------------------------------------",  contents.find("SUMMARY --------------------------------------------------------",contents.find("SUMMARY --------------------------------------------------------")+len("SUMMARY --------------------------------------------------------"))+len("SUMMARY --------------------------------------------------------"))
...
results = open("results-v3-testmodel.txt","w+")
